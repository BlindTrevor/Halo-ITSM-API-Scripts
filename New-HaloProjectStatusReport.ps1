...
#  connection first, then the two ticket type ids, then which project, then
...
# --- Which project, and where the report goes -------------------------------
...
# "id:NN". Name them here and they read properly.
...
# --- How the RAG verdict is judged ------------------------------------------
# A project is not in trouble because a burn-up
